...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("20/06/2021"), "Let's travel!", "I will travel to Brazil. See you later!", maria);
		Post post2 = new Post(null, sdf.parse("22/06/2021"), "Good morning!", "I'm so happy today ;)", maria);
